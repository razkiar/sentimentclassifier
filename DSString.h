...
public:
    ...
    /**
     * @brief Splits the string into substrings based on a specified delimiter and returns a vector of said substrings.
     *
     * @param delimiter The character used to determine where to split the string.
     * @return A vector of substrings that were spilt from based on a specified delimiter
     */
    std::vector<DSString> split(char delimiter) const;

    /**
     * @brief Returns the number of times a specified character appears in the string.
     *
